...
os.chdir(r'C:\karagoz\01-RESEARCH\01-Projects\01-In_silico_modeling_of_Integrin_function\003-Ligand_competition_model\Unique_clusters\figures_FN_THBS_equal_IC')
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 13}
...
df2.to_csv('F_THBS_equalIC_simResults.csv', sep='\t', index=False)
