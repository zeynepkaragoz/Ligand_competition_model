# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 12:16:17 2020
...
os.chdir(r'C:\karagoz\01-RESEARCH\01-Projects\01-In_silico_modeling_of_Integrin_function\003-Ligand_competition_model\Unique_clusters\figures_FN_vWF_foldChange_testing\FN_vWF_equal_FC_equal_bindingRates')
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 13}
...
df2.to_csv('F_vWA_equalFC_equal_bindingRates_simResults.csv', sep='\t', index=False)