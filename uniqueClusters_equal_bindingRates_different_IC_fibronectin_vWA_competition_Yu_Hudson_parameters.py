...
os.chdir(r'C:\karagoz\01-RESEARCH\01-Projects\01-In_silico_modeling_of_Integrin_function\003-Ligand_competition_model\Unique_clusters\figures_FN_vWF_equalBR_differentIC')
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 13}
...
df2.to_csv('F_vWA_equal_bindingRates_differentIC_differentFC_simResults.csv', sep='\t', index=False)