# -*- coding: utf-8 -*-
"""
Created on Thu May 28 12:23:13 2020
...
os.chdir(r'C:\karagoz\01-RESEARCH\01-Projects\01-In_silico_modeling_of_Integrin_function\003-Ligand_competition_model\ligands_free\02_equal_IC_different_FC')
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 13}
...
df2.to_csv('equalIC_diffFC_simResults.csv', sep='\t', index=False)
