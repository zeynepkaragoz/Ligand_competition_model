# -*- coding: utf-8 -*-
"""
Created on Thu May 28 10:36:40 2020
...
# [[ 0.0211578, 8.16097e-05, 3.55645e-10, 5.52537e-05, 7.11289e-09, 0.329863, 0.0143248, 2.13124e-07, 0.130137]]

#these are the steady state values.
print(r2.getRatesOfChange())
# [ 2.32773799e-10 -1.01021413e-11  8.66938222e-19  5.68434189e-14 0.00000000e+00 -4.23516474e-22] these are the rates of change of the 6 reactions, all approaching 0 --> confirm steady state. 
...
df2.to_csv('diffIC_diffFC_simResults.csv', sep='\t', index=False)
