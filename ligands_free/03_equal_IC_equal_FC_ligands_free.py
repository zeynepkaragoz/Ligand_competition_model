...
os.chdir(r'C:\karagoz\01-RESEARCH\01-Projects\01-In_silico_modeling_of_Integrin_function\003-Ligand_competition_model\ligands_free\03_equal_IC_equal_FC')
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 13}
...
df2.to_csv('equalIC_equalFC_simResults.csv', sep='\t', index=False)